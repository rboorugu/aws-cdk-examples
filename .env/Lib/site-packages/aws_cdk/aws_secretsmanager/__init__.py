...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-secretsmanager", "1.26.0", __name__, "aws-secretsmanager@1.26.0.jsii.tgz")
...
class ResourcePolicyProps():
    def __init__(self, *, secret: "ISecret"):
...
class SecretRotationApplicationOptions():
    def __init__(self, *, is_multi_user: typing.Optional[bool]=None):
...
__all__ = ["AttachedSecretOptions", "AttachmentTargetType", "CfnResourcePolicy", "CfnResourcePolicyProps", "CfnRotationSchedule", "CfnRotationScheduleProps", "CfnSecret", "CfnSecretProps", "CfnSecretTargetAttachment", "CfnSecretTargetAttachmentProps", "ISecret", "ISecretAttachmentTarget", "ISecretTargetAttachment", "ResourcePolicy", "ResourcePolicyProps", "RotationSchedule", "RotationScheduleOptions", "RotationScheduleProps", "Secret", "SecretAttachmentTargetProps", "SecretAttributes", "SecretProps", "SecretRotation", "SecretRotationApplication", "SecretRotationApplicationOptions", "SecretRotationProps", "SecretStringGenerator", "SecretTargetAttachment", "SecretTargetAttachmentProps", "__jsii_assembly__"]
